    ...
    <body>
        <div class="container">
            ...
            <div id="manualTab" class="tab-panel active">
                ...
                <div class="card">
                    <div class="card-title">Turret Configuration</div>
                    <div class="control-group">
                        <div class="control-label">
                            <span>Turret Number</span>
                        </div>
                        <input type="text" id="turretNumber" placeholder="Enter your turret number..." value=\"""" + turret_number + """\">
                    </div>
                </div>
                    ...
                    <div class="control-group">
                        ...
                        <div style="display: flex; gap: 0.5rem;">
                            <input type="text" id="turretNumber"
                                ...
                                value=\"""" + turret_number + """\"
                                style="flex: 1;">
                            <button class="btn btn-secondary btn-inline" id="turretSubmitBtn">
                                Set
                            </button>
                        </div>
                    </div>
        ...
        <script>
            ...
            // Turret number
            turretSubmitBtn.addEventListener('click', () => {
                sendToServer('turret_number', { number: turretNumberInput.value });
            });
